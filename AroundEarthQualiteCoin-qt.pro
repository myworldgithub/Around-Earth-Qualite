TEMPLATE = app
TARGET = AroundEarthQualiteCoin-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = AroundEarthQualiteCoin-qt_test
...
macx:ICON = src/qt/res/icons/AroundEarthQualiteCoin.icns
macx:TARGET = "AroundEarthQualiteCoin-Qt"
